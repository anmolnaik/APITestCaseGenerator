...
<head>
    <meta charset="utf-8">
    <title>lib/handlebar-helpers.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">lib/handlebar-helpers.js</h1>
...
function isNotDefaultStatusCode(code) {
    if (arguments.length &lt; 1) {
        throw new Error('Handlebars Helper \'isNotDefaultStatusCode\' needs 1 parameter');
    }
