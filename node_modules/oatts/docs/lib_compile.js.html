...
handlebars.registerHelper('isNotDefaultStatusCode', helpers.isNotDefaultStatusCode)
...
function compilePathLevel(processedPath, processed, options) {
    ...
    processedPath.operations.forEach(function(processedOp, ndx, arr) {
        var opLevelTest = compileOperationLevel(processedOp, processedPath, processed, options)
...
function compileOperationLevel(processedOp, processedPath, processed, options) {
    ...
    processedOp.transactions.forEach(function(transaction, ndx, arr) {
        var transactionTest = compileTransactionLevel(transaction, processedOp, processedPath, processed, options)
 ...
 */
function compileTransactionLevel(transaction, processedOp, processedPath, processed, options) {
