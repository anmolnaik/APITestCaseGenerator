...
<dl class="details">
    ...
    <h4 class="name" id="generate"><span class="type-signature"></span>generate<span class="signature">(specPath, options)</span><span class="type-signature"> &rarr; {Promise.&lt;<a href="global.html#GenerationResults">GenerationResults</a>>}</span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>specPath</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last">path to the API spec document</td>
        </tr>
...
<span class="param-type">object</span>
            ...
            <td class="description last">options to apply during processing of API spec</td>
        </tr>
...
<span class="param-type">Promise.&lt;<a href="global.html#GenerationResults">GenerationResults</a>></span>
    ...
    <h4 class="name" id="merge2"><span class="type-signature"></span>merge2<span class="signature">(obj1, obj2)</span><span class="type-signature"> &rarr; {object}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util.js.html">lib/util.js</a>, <a href="lib_util.js.html#line21">line 21</a>
    </li></ul></dd>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>obj1</code></td>
...
<span class="param-type">object</span>
            ...
            <td class="description last">dominant object to merge with</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>obj2</code></td>
...
<span class="param-type">object</span>
            ...
            <td class="description last">subordinate object to merge with</td>
        </tr>
...
<h4 class="name" id="GenerationResults">GenerationResults</h4>
...
<table class="props">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>generated</code></td>
...
<span class="param-type">Array.&lt;<a href="compilation.html#.GeneratedTest">compilation.GeneratedTest</a>></span>
            ...
            <td class="description last">set of generated test objects</td>
        </tr>
